      ...
      <div class="footer-inner">
        <div class="footer-brand">
          <a href="/" class="logo footer-logo" aria-label="RandomWheel Home">
            ...
            <div class="logo-text"><span class="logo-main">Random Wheel </span><span class="logo-accent"> Spinner</span></div>
          </a>
          ...
          <div class="footer-social">
            <a href="https://github.com/randomwheel/randomwheel.github.io" aria-label="Share on GitHub" class="social-btn">
